      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php echo $this->uri->segment(2) == 'barang' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>barang"><i class="far fa-square"></i><span>Data Barang</span></a></li>
            <li class="<?php echo $this->uri->segment(2) == 'pegawai' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>pegawai"><i class="far fa-square"></i><span>Manage Pegawai</span></a></li>
            <li class="<?php echo $this->uri->segment(2) == 'member' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>member"><i class="far fa-square"></i><span>Manage member</span></a></li>
            <li class="<?php echo $this->uri->segment(2) == 'transaksi' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>transaksi"><i class="far fa-square"></i><span>Transaksi</span></a></li>
